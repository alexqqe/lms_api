...
public class ProblemServiceTest {
    ...
    void testCreateProblem_True() {
        ...
        Problem createdProblem = problemService.createProblem(problemCreationDto);
    ...
    void testCreateMultipleProblems_IdsIncrement() {
        Problem firstProblem = new Problem("First", "First desc");
        Problem secondProblem = new Problem("Second", "Second desc");

        Problem problem1 = problemService.createProblem(firstProblem);
        Problem problem2 = problemService.createProblem(secondProblem);
